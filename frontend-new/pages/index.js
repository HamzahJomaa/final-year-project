                ...
                <div className="container">
                    <div className="row ipad-width">
                        <div className="col-md-8">
                            <SectionComponent title={"Movies"} titles={["Top Rated","Top Reviewed"]} data={[top_rated,top_reviewed]} />
                            <SectionComponent title={"Series"} titles={["Top Rated","Top Reviewed"]} data={[top_rated_series,top_reviewed_series]} />
                            {personalizedGenre && <SectionComponent title={"Genres"} titles={["Genres"]} data={[personalizedGenre]} />}
